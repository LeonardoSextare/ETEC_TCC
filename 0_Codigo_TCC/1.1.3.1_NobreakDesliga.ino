...
void menu_NobreakDesliga()
{
  tft.fillRoundRect(0, 70, 320, 410, 0, WHITE);

  // Segura quedas de energia?

  tft.fillRoundRect(0, 70, 320, 35, 0, BLACK);
  tft.setTextSize(2);
  tft.setTextColor(WHITE);
  tft.setCursor(10, 80);
  tft.println("Segura quedas de energia?");
  ...
  tft.println("Desliga inesperadamente?");
...
void btn_NobreakDesliga(int caso)
{
  switch (caso)
  {
